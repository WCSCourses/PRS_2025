...
> ```
> ```
> mv ~/Downloads/Day2_Base_Data.zip ~/Day2_Target_Data
> ```
...
![Figue](/course_data_2025/images/Day2.docxfolder/Height.gws_BARPLOT_2023-07-03.png)
...
```
Rscript ~/PRSice.R --prsice ~/PRSice_linux --base Base_Data/GIANT_Height.txt --target Target_Data/TAR --snp MarkerName --A1 Allele1 --A2 Allele2 --stat b --beta --pvalue p --pheno Target_Data/TAR.height --binary-target F --fastscore --out Results/Height.fast 
```
...
![Figure 1.1](/course_data_2025/images/Day2.docxfolder/images-018.png)
...
```
 Rscript ~/PRSice.R --prsice ~/PRSice_linux --base Base_Data/GIANT_Height.txt --target Target_Data/TAR --snp MarkerName --A1 Allele1 --A2 Allele2 --stat b --beta --pvalue p --pheno Target_Data/TAR.height --binary-target F --out Results/Height.highres
```
...
![Figure 1.2.2](/course_data_2025/images/Day2.docxfolder/Height.highresBARPLOT2023-06-23.png) 
...
```
Rscript ~/PRSice.R --prsice ~/PRSice_linux --base Base_Data/GIANT_Height.txt --target Target_Data/TAR --snp MarkerName --A1 Allele1 --A2 Allele2 --stat b --beta --pvalue p --pheno Target_Data/TAR.height --binary-target F --cov Target_Data/TAR.covariate --cov-col Sex --out Results/Height.sex
```
...
```
Rscript ~/PRSice.R --prsice ~/PRSice_linux --base Base_Data/GIANT_Height.txt --target Target_Data/TAR --snp MarkerName --A1 Allele1 --A2 Allele2 --stat b --beta --pvalue p --pheno Target_Data/TAR.height --binary-target F --cov Target_Data/TAR.covariate --cov-col Sex --plot --quantile 10 --out Results/Height.sex
```

 **Figure 1.3: Example of a quantile plot generated by PRSice**
![Figure 1.3](/course_data_2025/images/Day2.docxfolder/Height.sex_QUANTILES_PLOT_2025-05-19.png)
...
```
Rscript ~/PRSice.R --prsice ~/PRSice_linux --base Base_Data/GIANT_Height.txt --target Target_Data/TAR --snp MarkerName --A1 Allele1 --A2 Allele2 --stat b --beta --pvalue p --pheno Target_Data/TAR.height --binary-target F --cov Target_Data/TAR.covariate --cov-col Sex --plot --quantile 100 --quant-break 1,5,10,20,40,60,80,90,95,99,100 --quant-ref 60 --out Results/Height.sex
```

 **Figure 1.4: Example of a strata plot generated by PRSice**
![Figure 1.4](/course_data_2025/images/Day2.docxfolder/images-036.png)
...
```
Rscript ~/PRSice.R --prsice ~/PRSice_linux --base Base_Data/cad.add.txt --target Target_Data/TAR --snp markername --A1 effect_allele --A2 noneffect_allele --chr chr --bp bp_hg19 --stat beta --beta --pvalue p_dgc --pheno Target_Data/CAD.pheno --binary-target T --out Results/CAD.highres
```
---
>
...
![Figure 1.5](/course_data_2025/images/Day2.docxfolder/CAD.highresBARPLOT2023-06-23.png)
...
![Figure 1.6](/course_data_2025/images/Day2.docxfolder/Cross.highBARPLOT2023-06-23.png)
